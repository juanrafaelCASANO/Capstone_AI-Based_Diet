...
/* Row wrapper must occupy full width and use flex */
.msg-wrapper {
...
/* Patient / User Row -> Forced LEFT */
.msg-wrapper.user-row {
  align-items: flex-start !important;
}

/* Nutritionist Row -> Forced RIGHT */
...
/* Patient Bubble (Left Side - Light Grey/White) */
.message.user-bubble {
...
/* Nutritionist Bubble (Right Side - Vibrant Blue/Teal) */
...
/* Read Status text under nutritionist message */
.msg-status {
  font-size: 10px;
  color: var(--muted);
  margin-top: 2px;
