...
// Get counts - Ensuring table names match your logic
$meal_count = $conn->query("SELECT COUNT(*) FROM meal_plans")->fetch_row()[0];

// Use 'nutritionists' for accounts as per your updated dashboard request
$nutri_res = $conn->query("SELECT COUNT(*) FROM nutritionist");
$nutritionist_count = ($nutri_res) ? $nutri_res->fetch_row()[0] : 0;
?>
...
<head>
    ...
    <style>
        ...
        /* Updated Header for Sign Out Button */
        header {
            background: #2563eb;
            color: #fff;
            padding: 20px 60px;
            display: flex;
            justify-content: space-between; /* Pushes logo/title and logout apart */
            align-items: center;
...
<div class="container">
    ...
    <div class="card">
        <div class="card-content">
            ...
            <p>Add, edit, or remove dietary programs.</p>
        </div>
    ...
    <div class="card">
        <div class="card-content">
            <h2>Registered Experts</h2>
            <p>Manage login accounts, emails, and credentials from the <b>nutritionists</b> table.</p>
        </div>
        <a class="btn btn-primary" href="manage_account.php">
            <i class="fa-solid fa-users-gear"></i> View Accounts
        </a>
    </div>
    ...
    <div class="card-content">
        ...
        <p>
            Monitor login history and actions performed by users and nutritionists
            such as logins, meal generation, and chat access.
        </p>
    </div>
    <a href="activity_logs.php" class="btn btn-green">
        📊 View Logs
    </a>
</div>
